...
>>>>>>>> 912cec3 (fix accoount add sql):data_haisan.sql
...
INSERT INTO Voucher (
  VoucherId, VoucherName, ReleaseDate, Expire, 
  ApplyAmount, MaxApply, DiscountValue, 
  IsCash, IsDebuted, IsDeactivated
)
VALUES 
-- Đã ra mắt, đang hoạt động
('V250401C01', N'Giảm tiền mùa hè', '2025-04-01', '2025-05-01', 500000, 50000, 50000, 1, 1, 0),
('V250401P01', N'Giảm 10% cho đơn lớn', '2025-04-01', '2025-06-01', 300000, 80000, 10, 0, 1, 0),

-- Chưa ra mắt (trong tương lai)
('V250501C01', N'Ưu đãi ngày Quốc tế Lao động', '2025-05-01', '2025-06-01', 400000, 40000, 40000, 1, 0, 0),
('V250515P01', N'Giảm giá tháng 5', '2025-05-15', '2025-06-15', 200000, 70000, 15, 0, 0, 0),

-- Đã ra mắt, đang hoạt động
('V250410C01', N'Ưu đãi đầu tháng 4', '2025-04-10', '2025-05-10', 250000, 30000, 30000, 1, 1, 0),
...
('Prod0001',  'Fish', N'Cá kình', 120000, GETDATE(), 'kg'),
('Prod0002', 'Fish',     N'Cá bống mú', 95000, GETDATE(), N'kg'),
('Prod0003', 'Crab',     N'Cua biển', 160000, GETDATE(), N'kg'),
('Prod0004', 'Shrimp',   N'Tôm sú', 190000, GETDATE(), N'kg'),
('Prod0005', 'Snail',   N'Ốc hương', 100000, GETDATE(), N'kg'),
('Prod0006', 'Clam',   N'Nghêu trắng', 60000, GETDATE(), N'kg'),
('Prod0007', 'Squid',   N'Mực ống', 140000, GETDATE(), N'kg'),
('Prod0008','Lobst',   N'Tôm hùm Alaska', 650000, GETDATE(), N'kg');
